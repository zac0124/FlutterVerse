  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'fr': {
          ...
          'auth.resetPasswordFailed':
              'Réinitialiser le mot de passe Email Échec',
        ...
        'hi': {
          ...
          'auth.updateUserSuccessNotice':
              'उपयोगकर्ता जानकारी सफलतापूर्वक अपडेट।',
          'auth.updateUserEmailInUse':
        ...
        'pt': {
          ...
          'auth.updateUserEmailInUse':
              'Este endereço de email já tem uma conta.',
          ...
          'auth.wrongPasswordNotice':
              'A senha não coincide com nossos registros.',
